...
pub fn process_repay(ctx: Context<Repay>, amount: u64)->Result<()>{
    ...
    bank.total_borrowed -= (bank.total_borrowed as f64 * E.powf(time_diff as f64 * bank.interest_rate as f64)).round() as u64;
    ...
    //since it's coming from the user associated token account, it's not a pda and we don't need  signer seeds
