...
pub fn process_withdraw(ctx: Context<Withdraw>, amount: u64)->Result<()>{
    ...
    bank.total_deposits =  (bank.total_deposits as f64 * E.powf((bank.interest_rate as f32 * time_diff as f32).into()) as f64) as u64;
    let value_per_share = bank.total_deposits as f64 /bank.total_deposit_shares as f64;
    let user_value =  deposited_value / value_per_share as u64;
    ...
    let signer_seeds: &[&[&[u8]]] = &[&[b"treasury",mint_key.as_ref(), &[ctx.bumps.bank_token_account]]];
    ...
    bank.total_deposit_shares -= bank.total_deposit_shares as u64;
    Ok(())
}